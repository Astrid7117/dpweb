...
class viewModel{
    ...
    // Solo estas vistas se pueden acceder directamente si existen en la carpeta /view
        $white_list = ["home", "products", "users", "new-user", "categories", "update", "edit-producto", "edit-categoria", "categoria", "produc", "new-cliente", "new-proveedor", "proveedor", "cliente", "edit-client", "edit-proveedor", "vista-cliente"];
